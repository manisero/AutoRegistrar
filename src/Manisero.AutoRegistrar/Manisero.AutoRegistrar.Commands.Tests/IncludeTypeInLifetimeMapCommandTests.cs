...
namespace Manisero.AutoRegistrar.Commands.Tests
{
	public class IncludeTypeInLifetimeMapCommandTests
	{
		...
		private readonly IsTypeConstructibleQuery _isTypeConstructibleQuery = new IsTypeConstructibleQuery();
		...
		[Test]
		public void single_constructible_dependency_not_present_in_map_nor_type_map___include_it_and_copy_its_lifetime()
		{
			// Arrange & Act
			var lifetimeMap = new Dictionary<Type, int>();
			Execute(lifetimeMap, typeof(ImplementationDependant));
		...
		[Test]
		public void single_inconstructible_dependency_not_present_in_map_nor_type_map___InvalidOperationException()
		{
			// Arrange & Act
			var lifetimeMap = new Dictionary<Type, int>();
			Action act = () => Execute(lifetimeMap, typeof(InterfaceDependant));
		...
		[Test]
		public void tree_partially_present_in_map_and_type_map_with_constructible_not_not_present_in_any_____include_missing_and_copy_lowest_lifetime()
		{
			// Arrange & Act
			var lifetimeMap = new Dictionary<Type, int>
				{
